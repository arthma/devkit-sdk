...
typedef int(*PNP_DEVICE_SEND_EVENT_ASYNC)(void* iothubClientHandle, IOTHUB_MESSAGE_HANDLE eventMessageHandle, IOTHUB_CLIENT_EVENT_CONFIRMATION_CALLBACK eventConfirmationCallback, void* userContextCallback);
typedef int(*PNP_DEVICE_SET_DEVICE_TWIN_CALLBACK)(void* iothubClientHandle, IOTHUB_CLIENT_DEVICE_TWIN_CALLBACK deviceTwinCallback, void* userContextCallback);
typedef int(*PNP_DEVICE_SEND_REPORTED_STATE)(void* iothubClientHandle, const unsigned char* reportedState, size_t size, IOTHUB_CLIENT_REPORTED_STATE_CALLBACK reportedStateCallback, void* userContextCallback);
typedef int(*PNP_DEVICE_SET_DEVICE_METHOD_CALLBACK)(void* iothubClientHandle, IOTHUB_CLIENT_DEVICE_METHOD_CALLBACK_ASYNC deviceMethodCallback, void* userContextCallback);
typedef void(*PNP_DEVICE_CLIENT_DESTROY)(void* iothubClientHandle);
typedef void(*PNP_DEVICE_CLIENT_DOWORK)(void* iothubClientHandle);
...
typedef struct PNP_IOTHUB_BINDING_TAG
{
    ...
    PNP_DEVICE_SEND_EVENT_ASYNC pnpDeviceSendEventAsync;
    PNP_DEVICE_SET_DEVICE_TWIN_CALLBACK pnpDeviceSetDeviceTwinCallback;
    PNP_DEVICE_SEND_REPORTED_STATE pnpSendReportedState;
    PNP_DEVICE_CLIENT_DESTROY pnpDeviceClientDestroy;
    PNP_DEVICE_SET_DEVICE_METHOD_CALLBACK pnpDeviceSetDeviceMethodCallback;
    PNP_DEVICE_CLIENT_DOWORK pnpDeviceClientDoWork;
...
MOCKABLE_FUNCTION(, PNP_CLIENT_CORE_HANDLE, PnP_ClientCore_Create, PNP_IOTHUB_BINDING*, iotHubBinding);
MOCKABLE_FUNCTION(, void, PnP_ClientCore_Destroy, PNP_CLIENT_CORE_HANDLE, pnpClientCoreHandle);
MOCKABLE_FUNCTION(, PNP_CLIENT_RESULT, PnP_ClientCore_AddInterfaceReferenceFromInterface, PNP_CLIENT_CORE_HANDLE, pnpClientCoreHandle);
MOCKABLE_FUNCTION(, void, PnP_ClientCore_RemoveInterfaceReference, PNP_CLIENT_CORE_HANDLE, pnpClientCoreHandle);
