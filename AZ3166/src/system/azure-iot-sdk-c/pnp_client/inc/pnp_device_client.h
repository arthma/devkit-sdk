...
*/
typedef void* PNP_DEVICE_CLIENT_HANDLE;
...
*
* @remarks  PnP_DeviceClient_RegisterInterfacesAsync registers specified pnpInterfaces with the PnP Service.  This registration occurrs
            ...
            PnP_DeviceClient_RegisterInterfacesAsync may not be called multiple times for the same PNP_DEVICE_CLIENT_HANDLE.  If a given PnP device
            needs to have its handles re-registered, it needs to PnP_DeviceClient_Destroy the existing PNP_DEVICE_CLIENT and create a new one.
