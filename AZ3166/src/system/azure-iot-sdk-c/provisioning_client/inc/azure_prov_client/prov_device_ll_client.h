...
* @return PROV_DEVICE_RESULT_OK upon success or an error code upon failure
*/
MOCKABLE_FUNCTION(, PROV_DEVICE_RESULT, Prov_Device_LL_SetProvisioningData, PROV_DEVICE_LL_HANDLE, handle, const char*, dataField);
...
*/
MOCKABLE_FUNCTION(, const char*, Prov_Device_LL_GetProvisioningData, PROV_DEVICE_LL_HANDLE, handle);
