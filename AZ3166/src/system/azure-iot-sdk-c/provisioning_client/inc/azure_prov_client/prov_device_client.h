...
* @param    jsonDataField   The data field that is sent to the service.  Setting dataField to NULL will unset the value previously set
*
* @return PROV_DEVICE_RESULT_OK upon success or an error code upon failure
*/
MOCKABLE_FUNCTION(, PROV_DEVICE_RESULT, Prov_Device_SetProvisioningData, PROV_DEVICE_HANDLE, handle, const char*, jsonDataField);
...
*/
MOCKABLE_FUNCTION(, const char*, Prov_Device_GetProvisioningData, PROV_DEVICE_HANDLE, handle);
